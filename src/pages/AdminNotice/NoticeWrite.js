                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="Write_input_container">
                                        <input class="Write_input" type="text" value={title} onChange={onNoticeChange} size="50px" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="Write_input_container">
                                        <textarea class="Write_input" value={content} onChange={onNoticeChange} rows="10"></textarea>
                                    </td>
                                </tr>
